...
#else
   return "application/x-renren-speedrtc";
#endif
}
...
{
   //DebugLog(<< __FUNCTION__ << " | variable: " << variable );
   if (future == NULL)
   {
      //DebugLog(<< "future is NULL");
   }
   else
   {
      //DebugLog(<<"future is not NULL");
   }
