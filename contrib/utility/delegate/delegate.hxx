#ifndef RRALBUM_DELEGATE_HXX
#define RRALBUM_DELEGATE_HXX
...
#include <delegate/thread_policy.hxx>
...
#include <delegate/internal/delegateTemplate.hxx>
...
typedef LNpPluginLib::Delegate<void (void)> NotifyEvent;

}
#endif // #ifndef RRALBUM_DELEGATE_HXX
